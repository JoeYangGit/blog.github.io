  ...
  <div>
    <div class="tech">
      <div class="tech-left">
        ...
        <div class="tech-left-title">全部技术</div>
      </div>
      <div class="tech-list">
        <div class="tech-list-left">
          <div class="tech-list-left-circle" :style="leftColor()" @click="prevPage()"></div>
        </div>
        <div class="tech-list-content">
          <div class="tech-list-content-box">
            <div
              class="tech-list-content-item"
              v-for="(item, index) in listData1"
              :key="item.id"
              @click="showDetailBox(item)"
            >
              <div class="tech-list-content-item-summary">
                <div
                  class="tech-list-content-item-summary-title"
                >{{currentIndex - 5 + index + '. ' + item.text}}</div>
                <div class="tech-list-content-item-summary-time">{{item.time}}</div>
              </div>
            </div>
            <template v-if="listData1.length < 3">
              <div class="tech-list-content-item-empty" v-for="item in emptyData" :key="item"></div>
            </template>
          </div>
          <div class="tech-list-content-box">
            <div class="tech-list-content-item" v-for="(item, index) in listData2" :key="item.id">
              <div class="tech-list-content-item-summary">
                <div
                  class="tech-list-content-item-summary-title"
        ...
        <div class="tech-list-right">
          <div class="tech-list-right-circle" :style="rightColor()" @click="nextPage()"></div>
        </div>
      </div>
    </div>
...
export default {
  ...
  mounted () {
    this.listData = [...this.listData, ...latestTech].reverse()
